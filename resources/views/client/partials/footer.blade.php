                    ...
                    <div class="footer-inner-wrap footer-col-block s2">
                        ...
                        <div class="tf-collapse-content">
                            <div class="footer-newsletter">
                                <p>
                                    Chúng tôi mời bạn đăng ký để đọc tin tức, ưu đãi và sự kiện mới nhất về công ty
                                    chúng
            ...
            <div class="container">
                <div class="footer-bottom-wrap">
                    <p class="text-dark">Copyright © 2025 by <span class="fw-medium">Tuan Anh.</span> All Rights
                        Reserved.</p>
                    <ul class="tf-payment">
                        <li class="item"><img src="{{ asset('client/images/payment/EximBank.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/ApplePay.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/DinersClub.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/Discover.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/GooglePay.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/Mastercard-2.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/Mastercard.png') }}"
                                alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/Shop.png') }}" alt="payment">
                        </li>
                        <li class="item"><img src="{{ asset('client/images/payment/UnionPay.png') }}"
                                alt="payment">
                        </li>
