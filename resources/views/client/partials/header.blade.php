                ...
                <nav class="box-navigation text-center">
                    <ul class="box-nav-menu">
                                    ...
                                    <div class="mega-menu-item">
                                        ...
                                        <ul class="menu-list">
                                            ...
                                            <li><a href="shop-sub-collection-02.html" class="menu-link-text link">Sub
                                                    Collection 2</a></li>
                                            <li><a href="shop-grid-3-columns.html" class="menu-link-text link">Grid 3
                                                    Columns</a></li>
                                    ...
                                    <div class="mega-menu-item">
                                        ...
                                        <ul class="menu-list">
                                            <li><a href="shop-default.html" class="menu-link-text link">Pagination
                                                    Links</a></li>
                                            <li><a href="shop-load-more-button.html" class="menu-link-text link">Load
                                                    More Button</a></li>
                                    ...
                                    <div class="mega-menu-item">
                                        ...
                                        <ul class="menu-list">
                                            ...
                                            <li><a href="home-fashion-02.html" class="menu-link-text link">Product
                                                    Popup</a></li>
                                            <li><a href="index-2.html" class="menu-link-text link">Newsletter Popup
                                                    1</a></li>
                                    ...
                                    <div dir="ltr" class="swiper tf-swiper hover-sw-nav wow fadeInUp"
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="wg-cls style-abs asp-1 hover-img">
                                                    <a href="shop-default.html" class="image img-style d-block">
                                                        <img src="{{ asset('client/images/cls-categories/fashion/men-2.jpg') }}"
                                                            data-src="{{ asset('client/images/cls-categories/fashion/men-2.jpg') }}"
                                                            alt="" class="lazyload">
                                                    </a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="wg-cls style-abs asp-1 hover-img">
                                                    <a href="shop-default.html" class="image img-style d-block">
                                                        <img src="{{ asset('client/images/cls-categories/fashion/women.jpg') }}"
                                                            data-src="{{ asset('client/images/cls-categories/fashion/women.jpg') }}"
                                                            alt="" class="lazyload">
                                                    </a>
                                                    <div class="cls-btn text-center">
                                                        <a href="shop-default.html"
                                        ...
                                        <div class="swiper-wrapper">
                                                ...
                                                <div class="card-product">
                                                    <div class="card-product-wrapper">
                                                        <a href="product-detail.html" class="product-img">
                                                            <img class="img-product lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-12.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-12.jpg') }}"
                                                                alt="image-product">
                                                    ...
                                                    <div class="card-product-info text-center">
                                                        <a href="product-detail.html"
                                                            class="name-product link fw-medium text-md">Daystak Chair
                                                            RD1</a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card-product">
                                                    <div class="card-product-wrapper">
                                                        <a href="product-detail.html" class="product-img">
                                                            <img class="img-product lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-8.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-8.jpg') }}"
                                                                alt="image-product">
                                                            <img class="img-hover lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-7.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-7.jpg') }}"
                                                                alt="image-product">
                                                        </a>
                                                        <ul class="list-product-btn">
                                                            <li>
                                                    ...
                                                    <div class="card-product-info text-center">
                                                        <a href="product-detail.html"
                                                            class="name-product link fw-medium text-md">Loose Fit
                                                            Tee</a>
                                                        <p class="price-wrap fw-medium">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card-product">
                                                    <div class="card-product-wrapper">
                                                        <a href="product-detail.html" class="product-img">
                                                            <img class="img-product lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-30.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-30.jpg') }}"
                                                                alt="image-product">
                                                            <img class="img-hover lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-10.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-10.jpg') }}"
                                                                alt="image-product">
                                                        </a>
                                                        <ul class="list-product-btn">
                                                            <li>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card-product">
                                                    <div class="card-product-wrapper">
                                                        <a href="product-detail.html" class="product-img">
                                                            <img class="img-product lazyload"
                                                                ...
                                                                alt="image-product">
                                                            <img class="img-hover lazyload"
                                                                data-src="{{ asset('client/images/products/fashion/product-21.jpg') }}"
                                                                src="{{ asset('client/images/products/fashion/product-21.jpg') }}"
                                                                alt="image-product">
                                                        </a>
                                                        <ul class="list-product-btn">
                                                            <li>
                                                    ...
                                                    <div class="card-product-info text-center">
                                                        <a href="product-detail.html"
                                                            class="name-product link fw-medium text-md">Oversized Fit
                                                            Tee</a>
                                                        <p class="price-wrap fw-medium">
                        ...
                        <li class="menu-item position-relative">
                            <a href="#" class="item-link">Trang<i class="icon icon-arr-down"></i></a>
                            <div class="sub-menu sub-menu-style-2">
                                ...
                                <div class="banner hover-img">
                                    <a href="blog-single.html" class="img-style">
                                        <img src="{{ asset('client/images/blog/banner-header.jpg') }}"
                                            alt="banner">
                                    </a>
                                    <div class="content">
                                        <div class="title">
                        ...
                        <li class="menu-item position-relative">
                            <a href="{{ route('clients.blog') }}" class="item-link">Bài Viết<i
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="content">
                                                <a href="blog-single.html" class="fw-medium text-sm link title">The
                                                    Power of Monochrome: Styling One Color</a>
                                        ...
                                        <li class="item">
                                            ...
                                            <div class="content">
                                                <a href="blog-single.html" class="fw-medium text-sm link title">10
                                                    Must-Have Accessories for Every Season</a>
                                                <span class="text-xxs text-grey date-post">Sep 19 2025</span>
                                            </div>
                                        </li>
                                        <li class="item">
                                            ...
                                            <div class="content">
                                                <a href="blog-single.html" class="fw-medium text-sm link title">How to
                                                    Elevate Your Look with Layering</a>
                                                <span class="text-xxs text-grey date-post">Sep 19 2025</span>
                                            </div>
                                        </li>
                                    </ul>
