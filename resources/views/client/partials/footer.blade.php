            ...
            <div class="row-footer">
                        ...
                        <div class="footer-contact">
                            <ul class="footer-info">
                                ...
                                <li class="item">
                                    ...
                                    <a href="tel:18888383022">(+84) 2568 7430</a>
                                </li>
                                <li class="item">
                                    <span class="box-icon">
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    ...
                                    <a href="mailto:support@example.com">tanh24.fpt@gmail.com</a>
                                </li>
                            </ul>
                ...
                <div class="footer-inner-wrap footer-col-block s2">
                    ...
                    <div class="tf-collapse-content">
                        <div class="footer-newsletter">
                            <p>
                                Chúng tôi mời bạn đăng ký để đọc tin tức, ưu đãi và sự kiện mới nhất về công ty chúng
                                tôi. Chúng tôi cam kết không spam hộp thư đến của bạn.
                            </p>
                ...
                <div class="footer-inner-wrap s3">
                    <div class="footer-col-block inner-col">
                        <div class="footer-heading footer-heading-mobile text-xl fw-medium">Giới thiệu về chúng tôi
                        </div>
                        <div class="tf-collapse-content">
                            <ul class="footer-menu-list">
                                <li>
                                    <a href="about-us.html">Giới thiệu về chúng tôi</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="about-us.html">Câu chuyện của chúng tôi</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="footer-col-block inner-col">
                        ...
                        <div class="tf-collapse-content">
                            <ul class="footer-menu-list">
                                ...
                                <li>
                                    <a href="return-and-refund.html">Trả lại & Hoàn tiền
                                    </a>
                                </li>
                                <li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-wrap">
                <p class="text-dark">Copyright © 2025 by <span class="fw-medium">Tuan Anh.</span> All Rights
                    Reserved.</p>
                <ul class="tf-payment">
                    <li class="item"><img src="{{ asset('client/images/payment/EximBank.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/ApplePay.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/DinersClub.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/Discover.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/GooglePay.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/Mastercard-2.png') }}"
                            alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/Mastercard.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/Shop.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/UnionPay.png') }}" alt="payment">
                    </li>
                    <li class="item"><img src="{{ asset('client/images/payment/Visa.png') }}" alt="payment">
                    </li>
                </ul>
            </div>
        </div>
